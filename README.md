...
**chess-tui** is a free, open-source **terminal chess** game. Looking for a **chess CLI** or **chess in the terminal**? One app: play with a friend locally, against any **UCI chess engine** (e.g. **Stockfish**), or **online via Lichess**. Runs on **macOS, Linux, and Windows**.
