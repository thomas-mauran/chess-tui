...
#[cfg(test)]
mod tests {
  use crate::{board::Board, pieces::{PieceType, PieceColor, queen::Queen}};
  ...
  fn queen_moves_enemies_and_allies() {
      let custom_board = [
        ...
        [None, None, None, None, None, None, None, None],
        [None, None, None, None, None, None, None, None],
        [None, None, None, Some((PieceType::Pawn, PieceColor::Black)), Some((PieceType::Pawn, PieceColor::White)), None, None, None],
        [None, Some((PieceType::Pawn, PieceColor::Black)), None, None, Some((PieceType::Queen, PieceColor::White)), None, None, None],
        [None, None, None, None, None, Some((PieceType::Pawn, PieceColor::Black)), None, None],
        [None, None, None, None, None, None, None, None],
